...
export default function AdminSidebar({
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="md:hidden flex items-center justify-between bg-[#172A39] text-white p-4">
      ...
      <aside
        className={cn(
          "w-64 bg-[#172A39] text-white flex flex-col shrink-0",
      ...
      >
        <div className="p-6 border-b border-white/10 hidden md:block">
          <div className="text-xs tracking-[3px] uppercase text-[#a61968] mb-1">
            Admin Panel
          </div>
          <div className="font-serif text-lg">Content Level Up</div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                <Icon size={18} className="text-[#a61968]" />
                {item.label}
              </Link>
            );
          })}
